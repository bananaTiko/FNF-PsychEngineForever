...
class DiscordClient
{
	...
	private static var _options:Dynamic = {
		...
		state: null,
		largeImageKey: 'icon',
		largeImageText: "Psych Engine Forever",
		smallImageKey : null,
		startTimestamp : null,
		endTimestamp : null
	};
	...
	public static function changePresence(details:String, state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		_options.largeImageText = "Psych Engine Version: " + states.MainMenuState.psychEngineVersion "Engine Version: " + states.MainMenuState.psychEngineForeverVersion;
